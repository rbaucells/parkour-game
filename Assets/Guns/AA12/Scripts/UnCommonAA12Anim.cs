...
public class UnCommonAA12Anim : AbstractGunAnimator
{
    ...
    void Start()
    {
        ...
        reloadSequence
            .Append(magOrigin.DOLocalMove(new Vector3(0,-0.64f,1.03f), 0.4f))
            .Join(magMat.DOFade(0, 0.25f))
            .JoinCallback(() => PlayAudio.Invoke(0))
            .Append(magOrigin.DOLocalMove(new Vector3(0, -0.73f, 1.286f), 0.15f))
