...
public class EpicAAAA12Animator : AbstractGunAnimator
{
    Audio audioPlayer;
    Reloading reloading;
    ...
    void Start()
    {
        ...
        reloadSequence
            ...
            .Join(magazineOrigin.DOLocalMove(new Vector3(0, -0.559f, 1.159f), 0.34f)) // Move to the right position
            .Join(recoilOrigin.DOPunchRotation(new Vector3(-4f, 0f, 0f), 0.25f, 10, 1.0f)) // Punch recoil to simulate magazine ejection
            ...
            .Append(magazineOrigin.DOLocalMove(new Vector3(0, 0.384f, 1.101f), 0.32f))
