...
public class RareAAA12Animator : AbstractGunAnimator
{
    Audio audioPlayer;
    Reloading reloading;
    ...
    void Start()
    {
        ...
        reloadSequence
            ...
            .Join(magazineOrigin.DOLocalMove(new Vector3(0, -0.559f, 1.159f), 0.27f)) // Move to the right position
            ...
            .Append(magazineOrigin.DOLocalMove(new Vector3(0, 0.384f, 1.101f), 0.25f))
