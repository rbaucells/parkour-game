    ...
    void Start()
    {
        ...
        reloadSequence
            ...
            .InsertCallback(0.3f,() => 
            {
                ...
                magRig.AddForce(magazineOrigin.up * 0.1f + magazineOrigin.right * 2f + magazineOrigin.forward * Random.Range(-2, 2), ForceMode.Impulse); // Add Force
            })
            ...
            .AppendCallback(() => 
            {
                ...
                magazineOrigin.localRotation = Quaternion.Euler(0, -90, 25); // Set Rot while still Invisible
            })
